...
Port Scanner is a desktop-based network scanning utility built with Python and Tkinter. It provides a simple graphical interface for launching common Nmap scans and viewing the output inside the application window.
